...
const AirportDetails = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get(`http://147.93.53.128:8888/admin/airport/${airportId}`, {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            await axios.put(`http://147.93.53.128:8888/admin/airport/${airportId}`, formData, {
                headers: {
