...
const Rooms = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get("http://147.93.53.128:8888/admin/room", {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(
                "http://147.93.53.128:8888/admin/room",
                formData,
    ...
    const handleConfirmDelete = async () => {
        try {
            await axios.delete(`http://147.93.53.128:8888/admin/room/${airlineToDelete}`, {
                headers: { Authorization: `Bearer ${token}` },
            });
