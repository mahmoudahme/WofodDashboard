...
const Airline = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get("http://147.93.53.128:8888/admin/airline", {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(
                "http://147.93.53.128:8888/admin/airline",
                formData,
    ...
    const handleConfirmDelete = async () => {
        try {
            await axios.delete(`http://147.93.53.128:8888/admin/airline/${airlineToDelete}`, {
                headers: { Authorization: `Bearer ${token}` },
            });
