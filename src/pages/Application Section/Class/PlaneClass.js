...
const PlaneClass = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setAirline([...airlines, response.data.classOfPlane]);
    ...
    return (
        <div className="airport-container">
            ...
            <form onSubmit={handleSubmit} className="airport-form">
                <h2>إضافة درجة طيران جديده </h2>
                <label> : اسم درجة طيران بالعربية </label>
                <input type="text" name="nameAr" value={formData.nameAr} onChange={handleChange} required />

                <label> : اسم درجة طيران بالإنجليزية </label>
                <input type="text" name="nameEn" value={formData.nameEn} onChange={handleChange} required />

                <button type="submit">إضافة درجة طيران <FaHotel /></button>
            </form>

            {showConfirm && (
                <div className="confirm-modal">
                    <div className="confirm-box">
                        <p>هل أنت متأكد أنك تريد حذف هذه درجة طيران ؟</p>
