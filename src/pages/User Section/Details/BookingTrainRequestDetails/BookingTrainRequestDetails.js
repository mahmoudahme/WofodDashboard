...
const BookingTrainRequestDetails = () => {
        ...
        const fetchData = async () => {
            try {
                ...
                const response = await axios.get(
                    `http://147.79.101.225:8888/admin/request/train/${requestId}`,
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            await axios.post("http://147.79.101.225:8888/admin/send-notification", { memberId: "67da85b85c9ea288cdb9c428" },
                {
                    headers: {
                        Authorization: `Bearer ${token}`,
                        "Content-Type": "application/json",
            ...
            <div className="request-details">
                {request && (
                    <div className="request-details">
                        ...
                        {request.hotel && (
                            <p><strong>الفندق:</strong> {request.hotel.nameAr}</p>
                        )}
...
export default BookingTrainRequestDetails;
